            ...
            <Jumbotron style={{ padding: '1rem' }}>
                <CardColumns >
                    <Card bg="success" border="primary" text="light">
                        ...
                        <Link to="/quote"> <Button variant="success">Get a Quote</Button></Link>
                    ...
                    <Card border="primary" bg="warning" text="light">
                        ...
                        <Link to="/quote"> <Button variant="warning">Get a Quote</Button></Link>
                    </Card>
                    <Card border="primary" bg="danger" text="light">
                        <Card.Body>
                            <Row className="align-items-center">
                                <Col>
                        ...
                        <Link to="/quote"> <Button variant="danger">Get a Quote</Button></Link>
                    </Card>
                </CardColumns>
                <Row><hr></hr></Row>
                <Row><hr></hr></Row>
